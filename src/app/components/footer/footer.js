...
const countries = [
  ...
  { name: "UK English", flag: "/assets/ukflag.svg" },
  { name: "Canada English", flag: "/assets/canadaflag.svg" },
  { name: "Germany German", flag: "/assets/germanyflag.svg" },
  { name: "France French", flag: "/assets/franceflag.svg" },
  { name: "Spain Spanish", flag: "/assets/spainflag.svg" },
  { name: "Italy Italian", flag: "/assets/italyflag.svg" },
  { name: "India English", flag: "/assets/indiaflag.svg" },
  { name: "Japan Japanese", flag: "/assets/japanflag.svg" },
  { name: "China Chinese", flag: "/assets/chinaflag.svg" },
];
...
function Footer() {
    ...
    return (
        ...
        <div className='bg-[#000000] pt-[60px] min-h-[100px] px-[100px]'>
        ...
        <div className='h-screen layer hidden w-[100%] glass fixed bottom-[0px] left-[0px] z-[9]'></div>
            ...
            {/* ========== */}
            <div className='bg-[#000000] pt-[60px] min-h-[100px] px-[0px]'>
